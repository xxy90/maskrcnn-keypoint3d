...
def get_dataset(name, image_set, transform):
    paths = {
        "coco": ('/data/ai/xxy/PoseEstimation/tf-cpn/data/COCO/COCO2017', get_coco, 91),
        "coco_kp": ('/data/ai/xxy/PoseEstimation/tf-cpn/data/COCO/COCO2017', get_coco_kp, 2)
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-path', default='/data/ai/xxy/PoseEstimation/tf-cpn/data/COCO/COCO2017', help='dataset')
    ...
    parser.add_argument('--distributed', default=True, type=bool, help='multi-gpu')
    ...
    parser.add_argument('--gpu', default='2,3', help='gpu ids')
